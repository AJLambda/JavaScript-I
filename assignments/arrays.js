...
console.log(`The last car in inventory is a ${inventory[lastCar].car_make} ${inventory[lastCar].car_model}`);
...
console.log("A list of all the BMW and Audi cars on the lot:" + JSON.stringify(BMWAndAudi));
